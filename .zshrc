...
# FUNCTIONS
# ============================================================================
# Functions from fish config (adapted to zsh)
function backup {
    cp $1 $1.bak
}
...
# ALIASES
# ============================================================================
# Navigation shortcuts (kept existing, merged non-conflicting)
alias ..="cd .."
alias ...="cd ../.."
alias ....="cd ../../.."
alias .....="cd ../../../.."
...
# Directory shortcuts (kept existing)
alias dl="cd ~/Downloads"
alias doc="cd ~/Documents"
alias dt="cd ~/Desktop"

# Tools and utilities (kept existing, added non-conflicting)
alias g="git"
...
# From fish config (removed duplicates like .., conflicting like ls/grep which are already colored; removed non-Arch like apt/apt-get as they point to man pacman but may confuse; kept Arch-specific)
...
#alias yay='paru' # if paru is installed
...
alias ff='fastfetch --logo-type file --logo ~/.config/fastfetch/arch.txt'
...
alias dcs-health-analize='sudo echo "=== БАТАРЕЯ ===" && upower -i /org/freedesktop/UPower/devices/battery_BAT1 | grep -E "capacity|energy-full" && echo "=== SSD ===" && sudo smartctl -a /dev/nvme0n1 | grep -E "Percentage Used|Available Spare|Data Units Written"'
...
# Dart CLI completion
[[ -f /home/deltacat/.config/.dart-cli-completion/zsh-config.zsh ]] && \
. /home/deltacat/.config/.dart-cli-completion/zsh-config.zsh || true
